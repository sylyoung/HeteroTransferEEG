...
# @Author  : Siyang Li
# @File    : sda-mixup.py
# Xu et al. - 2020 - Adversarial Domain Adaptation with Domain Mixup
# implemented myself
import numpy as np
import argparse
import os
...
def mixup_sda(x_source, x_target, y_source, y_target, alpha=1.0, use_cuda=True):
    ...
    mixed_x = lam * x_source + (1 - lam) * x_target
    y_a, y_b = y_source, y_target
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        inputs, targets_a, targets_b, lam = mixup_sda(inputs_source, inputs_tgttrain, labels_source, labels_tgttrain,
                                                       args.alpha, args.data_env != 'local')
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.method = 'SDA-Mixup-' + str(args.num_target_train)
