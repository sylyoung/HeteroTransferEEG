...
# @Author  : Siyang Li
# @File    : sda-atm.py
# Li et al. - 2021 - Maximum Density Divergence for Domain Adaptation
# implemented myself
import numpy as np
import argparse
import os
...
from utils.loss import atm_loss
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        features = torch.cat((features_source, features_tgttrain), dim=0)
        labels = torch.cat((labels_source, labels_tgttrain))

        alignment_loss = atm_loss(features, labels, num_classes=args.class_num, left_weight=args.left_weight,
                                  right_weight=args.right_weight, cross_weight=args.cross_weight,
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.left_weight = 1  # source intra class min.
        args.right_weight = 1  # target intra class min.
        args.cross_weight = 1  # cross-domain min.
        args.inter_weight = 1  # target inter class max.
