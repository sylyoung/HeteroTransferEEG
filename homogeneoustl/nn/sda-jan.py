...
# @Author  : Siyang Li
# @File    : sda-jan.py
# Long et al. - Deep Transfer Learning with Joint Adaptation Netwo
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        alignment_loss = jmmd(
            ...
            (features_tgttrain, softmax(outputs_tgttrain, dim=1))
        )
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.method = 'SDA-JAN-' + str(args.num_target_train)
