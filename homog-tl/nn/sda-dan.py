...
# @Author  : Siyang Li
# @File    : sda-dan.py
# Long et al. - 2019 - Transferable Representation Learning with Deep Adaptation Networks
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        alignment_loss = mkmmd(features_source, features_tgttrain)
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.method = 'SDA-DAN-' + str(args.num_target_train)
