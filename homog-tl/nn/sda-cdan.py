...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        outputs = torch.cat((outputs_source, outputs_tgttrain), dim=0)
        softmax_out = nn.Softmax(dim=1)(outputs)
        entropy = Entropy(softmax_out)
        alignment_loss = CDANE([features, softmax_out], ad_net, entropy, calc_coeff(iter_num), args,
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.method = 'SDA-CDAN-' + str(args.num_target_train)
