...
# @Author  : Siyang Li
# @File    : sda-dsan.py
# Zhu et al. - 2021 - Deep Subdomain Adaptation Network for Image Classification
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        alignment_loss = lmmd(features_source, features_tgttrain, labels_source, labels_tgttrain, class_num=args.class_num)
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.method = 'SDA-DSAN-' + str(args.num_target_train)
