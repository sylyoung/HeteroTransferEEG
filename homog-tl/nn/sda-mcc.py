...
# @Author  : Siyang Li
# @File    : sda-mcc.py
# Jin et al. - 2020 - Minimum Class Confusion for Versatile Domain Adaptation
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        uncertainty_loss = ClassConfusionLoss(t=args.t_mcc)(outputs_tgttrain)
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.method = 'SDA-MCC-' + str(args.num_target_train)
        ...
        # temperature rescaling factor for MCC
        args.t_mcc = 2
