...
# @Author  : Siyang Li
# @File    : sda-ccsa.py
# Motiian et al. - 2017 - Unified Deep Supervised Domain Adaptation and Generalization
# implemented myself
import numpy as np
import argparse
import os
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        alignment_loss = csa(features_source, features_tgttrain,
                       (labels_source == labels_tgttrain).float())

        loss = source_classifier_loss * (1 - args.alignment_weight_ratio) + alignment_loss * args.alignment_weight_ratio
    ...
    # fine-tuning
    max_iter = (args.max_epoch // 10) * len(dset_loaders["source"])  # divide by 10
    interval_iter = max_iter // args.max_epoch
    args.max_iter = max_iter
    iter_num = 0
    base_network.train()
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.method = 'SDA-CCSA-' + str(args.num_target_train)
        ...
        # alignment loss weight ratio
        args.alignment_weight_ratio = 0.5
