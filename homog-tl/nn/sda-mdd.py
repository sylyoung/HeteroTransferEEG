...
# using https://github.com/thuml/Transfer-Learning-Library/blob/master/examples/domain_adaptation/image_classification/mdd.py implementation
import numpy as np
import argparse
import os
import torch
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        target_adv = outputs_tgttrain.max(1)[1]
        ...
        alignment_loss = args.srcweight * classifier_loss_adv_src + classifier_loss_adv_tgt
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.method = 'SDA-MDD-' + str(args.num_target_train)
